...
function enrollmentWorkbook(): UploadedFile
{
    ...
    $archive->addFromString('xl/sharedStrings.xml', '<?xml version="1.0"?><sst xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"><si><t>student_id_number</t></si><si><t>student_name</t></si><si><t>course</t></si><si><t>SKSU-2026-0001</t></si><si><t>Ana Cruz</t></si><si><t>BSIT</t></si></sst>');
    $archive->addFromString('xl/worksheets/sheet1.xml', '<?xml version="1.0"?><worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"><sheetData><row r="1"><c r="A1" t="s"><v>0</v></c><c r="B1" t="s"><v>1</v></c><c r="C1" t="s"><v>2</v></c></row><row r="2"><c r="A2" t="s"><v>3</v></c><c r="B2" t="s"><v>4</v></c><c r="C2" t="s"><v>5</v></c></row></sheetData></worksheet>');
    $archive->close();
